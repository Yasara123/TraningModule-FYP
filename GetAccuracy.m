...
bin=3.49*std([D1;D2])*power(length(D1)+length(D2),-1/3); %Scott suggested using the Gaussian density as a reference standard
%bin=100;
...
plot(x_values,y1,'LineWidth',2);hold on
